...
namespace E_CommerceSystem
{
    public partial class SignUp : KryptonForm
    {
        ...
        private void sign_up_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        string code = sendSMSNotification.sendSMS(signup_phone.Text, full_name.Text);

                        MySqlCommand insertTempSignUp = new MySqlCommand("INSERT INTO temporary_signups (userName,full_name, password, phoneNumber, Email, verificationCode) VALUES (@userName, @full_name, @password, @phoneNumber, @Email, @verificationCode)", conn);
                        insertTempSignUp.Parameters.AddWithValue("@userName", signup_username.Text);
                        insertTempSignUp.Parameters.AddWithValue("@full_name", full_name.Text);
                        ...
                        new Verification(validatedEmail, signup_username.Text, full_name.Text, cmbRegion.Text, cmbProvince.Text, cmbCity.Text, cmbBarangay.Text, postal_code.Text, street_name.Text, signup_phone.Text).Show();
                        this.Close();
        ...
        private void address_panel_Paint(object sender, PaintEventArgs e)
        {
